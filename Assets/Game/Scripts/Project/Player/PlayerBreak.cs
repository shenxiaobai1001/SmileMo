...
public class PlayerBreak : MonoBehaviour
{
    ...
    Vector3 leftForce = new Vector3(-8, 5);
    Vector3 rightForce = new Vector3(8, 5);
    ...
    void OnRestPos()
    {
        for (int i = 0; i < rigidbody2Ds.Count; i++)
        {
            ...
            rigidbody2Ds[i].transform.localPosition = Vector3.zero;
        }
    }
    public IEnumerator OnAddAllForceIE()
    {
        OnRestPos();
        Sound.PlaySound("Sound/Mod/die");
    ...
    {
        Sound.PlaySound("Sound/Mod/life");
