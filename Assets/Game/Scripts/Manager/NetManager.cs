...
public class NetManager : Singleton<NetManager>
{
    ...
    public void OnDispseMsg(DataInfo dataInfo)
    {
        ...
        {
            case "砸鸭子":
                CallManager.Instance.OnCreateDuckVideoPlayer(dataInfo);
                break;
            case "左边砸平底锅":
            ...
            case "番茄连招":
                ...
                break;
            case "Boom":
                ItemManager.Instance.OnBoomGrandma(dataInfo);
                break;
            //case "随机传送":
            ...
            case "呸":
                ...
                break;
            case "导弹":
                ItemManager.Instance.OnCreateRocket(dataInfo);
                break;
            case "隐身":
            ...
            case "减速":
                ...
                break;
            case "啄木鸟":
                ItemManager.Instance.OnCreateBird(dataInfo);
                break;
            case "砸落头像":
                ImageDownloader.Instance.OnRoleStar(dataInfo);
                break;
            case "打台球":
                ItemManager.Instance.OnCreateBilliard(dataInfo);
                break;
            case "大巴掌":
                ItemManager.Instance.OnCreateSlapFace(dataInfo);
                break;
            case "一阳指":
                MeshCreateController.Instance.OnCreateOneFinger();
                break;
            case "乌萨奇":
                ItemManager.Instance.OnCreateWuSaQi(dataInfo);
                break;
            case "传送第七关":
                ModSystemController.Instance.OnTransFarSeven();
                break;
            case "扔香蕉":
                ItemManager.Instance.OnCreateBanana(dataInfo);
                break;
            case "吐口水一":
                ItemManager.Instance.OnCreateTKS(dataInfo);
                break;
            case "吐口水二":
                ItemManager.Instance.OnCreateTKS(dataInfo);
                break;
            ...
            case "吐口水五":
                ...
                break;
            case "动物怎么叫":
                CallManager.Instance.OnCreateCall(dataInfo);
                break;
            case "火圈":
                ItemManager.Instance.OnCreateHuoquan(dataInfo);
                break;
            case "禁言":
                ItemManager.Instance.OnCreateBannedPost(dataInfo);
                break;
            case "跑快点":
                ItemManager.Instance.OnCreateGoFast(dataInfo);
                break;
            case "退退退":
                ItemManager.Instance.OnCreateGoBack(dataInfo);
                break;
            case "美女盲盒":
                CallManager.Instance.OnCreateVideoPlayer(dataInfo,1);
                break;
            case "动感DJ":
                CallManager.Instance.OnCreateVideoPlayer(dataInfo,2);
                break;
        }
    }
}
